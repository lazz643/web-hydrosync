...
const Buy = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      const script = document.querySelector('script[src="https://app.sandbox.midtrans.com/snap/v1/transactions"]');
      if (script) {
    ...
    <div className={styles.container}>
      ...
      <form className={styles.form}>
        ...
        <input
          ...
          name='Nomor Meter'
          value={findMeterId}
          onChange={(e) => setFindMeterId(e.target.value)}
          required
        />
      </form>
      ...
      <button type='button' className={menustyles.button} onClick={onSubmitChange}>Beli</button>
    </div>
  );
};
